...
#define MSG_CONTROL                         _UxGT("Impostazioni")
...
#define MSG_WATCH                           _UxGT("Schermata Princip.")
#define MSG_PRINT_MENU                      _UxGT("Avvia Stampa")
#define MSG_PREPARE                         _UxGT("Prepara")
#define MSG_COMMON_OPERATION                _UxGT("Operazioni comuni")
#define MSG_TUNE                            _UxGT("Regola")
#define MSG_MAINTENANCE                     _UxGT("Manutenzione")
...
#define MSG_PRINTING                        _UxGT("Stampa in corso...")
...
#define MSG_INFO_MENU                       _UxGT("Dati stampante")
